...
exports.syncPropertiesToTypesense = exports.processDocumentOcr = void 0;
...
exports.processDocumentOcr = (0, storage_1.onObjectFinalized)({ cpu: 2, memory: '1GiB' }, async (event) => {
...
exports.syncPropertiesToTypesense = (0, firestore_1.onDocumentWritten)({ document: 'tenants/{tenantId}/properties/{propertyId}', secrets: [typesenseApiKey] }, async (event) => {
